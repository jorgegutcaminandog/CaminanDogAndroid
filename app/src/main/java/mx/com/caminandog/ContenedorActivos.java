...
public class ContenedorActivos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_contenedor_activos, container, false);
    ...
    private void llenarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Paseos_Activos_Fragment(),getResources().getString(R.string.Activos));
